    ...
    <section id="solution" className="py-16 md:py-24 bg-gradient-to-br from-blue-50 to-green-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 md:mt-16 text-center">
          ...
          <Button 
            size="lg" 
            className="bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-base md:text-lg px-8 md:px-10 py-3 md:py-4 h-auto rounded-full"
